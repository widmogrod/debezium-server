...
import io.debezium.jdbc.*;
import io.debezium.server.*;
import io.debezium.server.events.*;
...
public class MongoDBCrateDBIT {
    private static final Logger LOGGER = LoggerFactory.getLogger(MongoDBCrateDBIT.class);
